...
public class InvalidEventStartDateException extends RuntimeException {
    public static final String DEFAULT_MESSAGE = "You can not create event with start date in the past. It has to exceed at lest 48 hours from moment of creation";
